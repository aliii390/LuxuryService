 ...
 */
final class Version20250211173023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD CONSTRAINT FK_288A3A4E311966CE FOREIGN KEY (slug_id) REFERENCES job_category (id)');
